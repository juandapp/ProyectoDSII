...
public class EstacionController implements Serializable {
    ...
    @EJB
    private logica.EstacionFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Estacion) getItems().getRowData();
    ...
    public static class EstacionControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Estacion) {
                ...
                return getStringKey(o.getNombreEstacion());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Estacion.class.getName());
            }
        }
    }
}
